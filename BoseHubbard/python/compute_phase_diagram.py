...
pos = ax.imshow(res_reshaped.T, origin='lower', extent=[0, 0.4, 0, 3], aspect='auto', cmap='viridis')
ax.set_xlabel(r"$t/U$")
ax.set_ylabel(r"$\mu/U$")
cbar=fig.colorbar(pos, ax=ax)
cbar.set_label(r'$\Phi$', rotation=0, labelpad=10)
plt.savefig("BHMF.png", dpi=1200, bbox_inches="tight", transparent=True)
# plt.show()